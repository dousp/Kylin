package com.dou.kylin.security.shiro.session.spinach;
...
public class ShiroSessionDao extends AbstractSessionDAO implements CacheManagerAware {
     ...
     * @throws UnknownSessionException if the id specified does not correspond to any session in the
     *                                 cache or EIS.
     */
     ...
     * {@link #doUpdate(Session)}. If the session is a
     ...
     * @throws UnknownSessionException if no existing EIS session record exists with the identifier
     ...
     *
     * @param session the session to remove from caches and permanently delete from
     *                the EIS.
     */
